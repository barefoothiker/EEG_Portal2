...
import { OverlayData, SaliencyData, BarPlotData, BrainData, Region, SaliencyInfo, BrainViewerData, RegionInfo, PredictionData, StatsImageObj, ReportData } from '../../models/overlayData';
...
@Component({
    ...
    providers: [ReportService, WebWorkerService],
...
export class ReportComponent implements OnInit{
 ...
 public barPlotOptions: ChartOptions = {
  ...
  ngOnInit() {
    ...
    this.reportService.getOverlayData(this.fileId).then(brainViewerData => {
