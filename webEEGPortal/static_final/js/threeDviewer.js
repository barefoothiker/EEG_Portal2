...
function init() {
    ...
    loader.load( "{% static " img/roi/lh.obj" %}", function ( object ) {
	brain = object;
    ...
    var loader = new THREE.OBJLoader( manager );
    loader.load( "{% static " img/roi/rh.obj" %}", function ( object ) {
	brain = object;
	object.traverse( function( child ) {
	    if ( child instanceof THREE.Mesh ) {
		child.castShadow = false;
    ...
    var loader = new THREE.OBJLoader( manager );
    loader.load( "{% static " js/roi/aseg_1006.obj" %}", function ( object ) {
	brain = object;
	object.traverse( function( child ) {
	    if ( child instanceof THREE.Mesh ) {
    ...
    var loader = new THREE.OBJLoader( manager );
    loader.load( "{% static " js/roi/aseg_17.obj" %}", function ( object ) {
	brain2 = object;
	object.traverse( function( child ) {
	    if ( child instanceof THREE.Mesh ) {
		child.castShadow = true;
    ...
    var loader = new THREE.OBJLoader( manager );
    loader.load( "{% static " js/roi/aseg_53.obj" %}", function ( object ) {
	brain2 = object;
	object.traverse( function( child ) {
	    if ( child instanceof THREE.Mesh ) {
		child.castShadow = true;
